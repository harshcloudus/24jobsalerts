  ...
  return (
    <div className="min-h-screen bg-white">
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-900 tracking-tighter text-charcoal mb-2 uppercase italic">Latest Job Openings</h1>
          <p className="text-text-body font-bold">Showing {totalItems} matches for your career profile</p>
        </div>

        <div className="flex flex-col sm:flex-row mb-8 bg-white rounded-xl border-[3px] border-charcoal divide-y-[3px] sm:divide-y-0 sm:divide-x-[3px] divide-charcoal overflow-hidden">
          <div className="flex-1 min-w-[250px] relative bg-white">
